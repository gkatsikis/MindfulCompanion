# Generated by Django 5.2.6 on 2025-10-01 14:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('requested_help_type', models.CharField(choices=[('acute_validation', 'acute_validation'), ('acute_skills', 'acute_skills'), ('chronic_education', 'chronic_education'), ('chronic_validation', 'chronic_validation'), ('max_validation', 'max_validation'), ('max_assessment', 'max_assessment')], help_text='What kind of support do you need today?', max_length=20)),
